...
style window:
    ...
    background Image("gui/textbox2.png", xalign=0.5, yalign=1.4)
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton ("") action SetScreenVariable("device", "keyboard")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text "   -   Advance dialogue and activates interface." yalign 1.0 size 33

    hbox:
        label _("Space")
        text "   -   Advance dialogue without selecting choice." yalign 1.0 size 33

    hbox:
        label _("Arrow Keys")
        text "  -  Navigate the interfaces." yalign 1.0 size 33
    ...
    hbox:
        label _("Ctrl")
        text "  -  Skip dialogue while held down." yalign 1.0 size 33

    hbox:
        label _("Tab")
        text "  -  Toggle dialogue skipping." yalign 1.0 size 33

    hbox:
        label "H "
        text "  -  Hide the user interface." yalign 1.0 size 33

    hbox:
        label "S "
        text "  -  Take a screenshot." yalign 1.0 size 33
    ...
    hbox:
        label "LMB "
        text "  -  Interact." yalign 1.0 size 33

    hbox:
        label "RMB "
        text "  -  Back." yalign 0.2 size 33
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                imagebutton:
                    style "confirm_prompt"
                    auto "Btnicons/ButtonYes_%s.png"
                    xpos 17 ypos -4
                    action yes_action
